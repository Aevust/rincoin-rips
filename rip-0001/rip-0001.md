...
The Rincoin Core software is provided under the MIT License without warranty of any kind. Any protocol modifications, software forks, or network parameter changes that bypass the formal approval process defined in this document — including the requisite approval of the Founder and Core Strategic Authority — are strictly unofficial.

The Rincoin Core Team disclaims all liability for any network consensus failures, asset loss, or security breaches resulting from the use of such unapproved software. The Core Team will not provide technical support, issue patches, or conduct emergency incident response for unauthorized forks or implementations.

Node operators, miners, and users who adopt unapproved changes do so entirely at their own risk.
